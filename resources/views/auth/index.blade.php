...
@section('content')
    ...
    <div class="flex text-center justify-center items-center">
        <div class="flex items-center">
            <a href="{{ route('peminjam.home.index') }}" class="bg-white py-2 px-6 rounded-full border border-blue-900 flex gap-2 items-center hover:bg-blue-900 hover:text-white transition-all duration-100 ease-in-out" data-aos="fade-up" data-aos-anchor-placement="center-bottom" data-aos-duration="900">
