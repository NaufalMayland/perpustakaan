            ...
            <div class="w-80">
                ...
                <div class="grid text-sm gap-2 my-4">
                    <div class="grid">
                        ...
                        <input class="border border-gray-500 py-2 px-3 rounded w-full" type="text" id="username" name="username" value="{{old('email')}}">
                    </div>
                    <div class="grid">
                ...
                <div class="flex justify-between items-center mt-8">
                    ...
                    <div class="">
                        <button type="submit" class="text-sm font-semibold bg-blue-600 rounded text-white py-2 px-4 hover:bg-blue-900">Register</button>
                    </div>
                </div>
            </div>
        </form>
