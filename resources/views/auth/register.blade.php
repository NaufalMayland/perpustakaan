...
<body class="bg-slate-50 font-['poppins']">
    <div class="w-auto h-screen items-center justify-center flex">
        <form action="{{ route('auth.registerAction') }}" method="POST" class="w-fit bg-[#fff] shadow rounded px-6 py-8">
            @csrf
            <div class="w-80">
                ...
                <div class="grid text-sm gap-2 my-4">
                    ...
                    <div class="grid">
                        ...
                        <input class="border border-gray-500 py-2 px-3 rounded w-full" type="email" id="email" name="email" autocomplete="off" value="{{ old('email') }}" placeholder="example@gmail.com">
                    </div>
