<button input-modal-target="#addListKategori" class="p-2 w-full justify-center rounded bg-blue-900 flex gap-1 items-center hover:bg-blue-950 cursor-pointer">
