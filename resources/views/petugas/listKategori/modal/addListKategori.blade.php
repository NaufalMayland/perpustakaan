<button input-modal-target="#addListKategori" class="py-2 px-4 w-full justify-center text-white rounded bg-blue-900 flex gap-2 items-center hover:bg-blue-950 cursor-pointer">
