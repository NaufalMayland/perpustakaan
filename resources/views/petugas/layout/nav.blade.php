<div class="bg-white shadow-lg w-auto h-screen sticky top-0 left-0 flex flex-col">
    ...
    <div class="text-center p-6">
        ...
        <button type="submit" class="py-2 px-5 text-sm text-white rounded-full bg-blue-900 hover:bg-white hover:text-blue-900 border-2 border-blue-900 transition-all duration-150 ease-in-out" onclick="confirmLogout()">
