    ...
    <form action="{{ route('petugas.buku.editBukuAction', $buku->id) }}" method="POST" class="flex flex-col lg:flex-row gap-8 items-start">
        ...
        <div class="w-full lg:w-3/4 flex flex-col gap-4 text-sm lg:text-base">
            ...
            <div class="grid text-sm">
                ...
                <textarea name="deskripsi" id="deskripsi" class="border-gray-300 border bg-gray-100 rounded p-2" required>{{ $buku->deskripsi }}</textarea>
            </div>
            <div class="grid">
            ...
            <div class="justify-end flex w-full items-center mt-2">
                <div class="flex">
