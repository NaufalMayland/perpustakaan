...
@section('content')
    <form method="POST" action="{{ route('petugas.buku.addBukuAction') }}" class="bg-white p-4 shadow rounded" enctype="multipart/form-data">
        @csrf
        @if ($errors->any())
        ...
        <div class="grid gap-2 text-sm mt-4">
            ...
            <div class="flex justify-end">
                <button class="flex items-center gap-1 bg-blue-900 hover:bg-blue-950 py-2 px-3 text-sm rounded-full text-white">
