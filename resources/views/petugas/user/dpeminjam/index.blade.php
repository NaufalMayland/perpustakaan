    ...
    <div class="bg-white p-4 rounded shadow-md">
        <div class="flex justify-between items-center">
            ...
            <div class="flex gap-2 text-white text-sm w-full">
                <a href="{{ route('petugas.user.dpeminjam.printPeminjam') }}" target="_blank" class="p-2 w-full justify-center rounded bg-blue-900 flex gap-1 items-center hover:bg-blue-900">
