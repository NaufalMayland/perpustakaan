            ...
            <table id="peminjamanTable" class="min-w-full border border-gray-400 text-sm">
                <thead class="bg-gray-400 w-full">
                    <tr class="text-gray-950">
                        ...
                        <th class="p-2 text-center font-bold uppercase relative">Petugas</th>
                        <th class="p-2 text-center font-bold uppercase relative">Tanggal Peminjaman</th>
                        <th class="p-2 text-center font-bold uppercase relative">Tanggal Pengembalian</th>
