    ...
    <div class="bg-white p-4 rounded shadow-md">
        <div class="flex justify-between items-center">
            ...
            <div class="flex gap-2 text-white text-sm w-full">
                <a href="{{ route('petugas.peminjaman.printPeminjaman') }}" target="_blank" class="p-2 w-full justify-center rounded bg-blue-900 flex gap-1 items-center hover:bg-blue-950">
                ...
                <a href="{{ route('petugas.peminjaman.importPeminjaman') }}" class="p-2 w-full justify-center rounded bg-blue-900 flex gap-1 items-center hover:bg-blue-950">
                    <i class="fa-solid fa-file-import"></i>
                    <span>Import</span>
                </a>
                <a href="{{ route('petugas.peminjaman.addPeminjaman') }}" class="p-2 w-full justify-center rounded bg-blue-900 flex gap-1 items-center hover:bg-blue-950">
            ...
            <table class="text-sm" id="peminjamanTable">
                <thead class="w-full">
                    <tr>
                        ...
                        <td class="p-2 text-center font-bold uppercase bg-slate-200">Petugas</td>
                        <td class="p-2 text-center font-bold uppercase bg-slate-200">Tanggal Peminjaman</td>
                        <td class="p-2 text-center font-bold uppercase bg-slate-200">Tanggal Pengembalian</td>
                        <td class="p-2 text-center font-bold uppercase bg-slate-200">Tanggal Dikembalikan</td>
