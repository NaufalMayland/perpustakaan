...
@section('content')
    @if ($riwayat->isEmpty()) 
        <div class="flex flex-col items-center justify-center h-64">
            ...
            <span class="text-neutral-400 mt-4">Tidak ada riwayat peminjaman</span>    
        </div> 
    @else
                    ...
                    <div class="grid gap-4">
                        ...
                        <div class="grid gap-2">
                            ...
                            <div class="text-sm text-neutral-500 text-left">
                                ...
                                <div>
                                    <span class="font-bold">Tanggal dikembalikan: </span>
                                    <span>{{ \Carbon\Carbon::parse($item->tanggal_dikembalikan)->translatedFormat('j F Y') }}</span>
                                </div>
                                <div>
                        ...
                        <div class="flex justify-center text-center gap-2">
                            <a href="{{ route('peminjam.detailRiwayat', $item->id) }}" class="flex justify-center items-center bg-blue-900 hover:bg-blue-950 py-2 px-3 gap-1 rounded-full text-white">
